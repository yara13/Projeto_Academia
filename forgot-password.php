...
<head>
  ...
  <title>Portal Admin - Esqueci minha senha</title>
        ...
        <form>
          <div class="form-group">
            <div class="form-label-group">
              <input type="email" id="inputEmail" class="form-control" placeholder="Digite seu email" required="required" autofocus="autofocus">
